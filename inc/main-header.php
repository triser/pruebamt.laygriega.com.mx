...
<!-- Main Header -->
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg"><b>SISTEMA</b> MLT</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <small>Miembro desde <?php echo date('M. Y',strtotime($_SESSION['fecha_alta']));?></small> 
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="./admin.php?view=perfil" class="btn btn-default btn-flat">Perfil</a>
                </div>
                <div class="pull-right">
                  <a href="./process/logout.php" class="btn btn-default btn-flat">Cerrar Session</a>
                </div>
              </li>
            </ul>
          </li>
 ...
 <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="./index.php?view=perfil-usuario" class="btn btn-default btn-flat">Perfil</a>
                </div>
                <div class="pull-right">
                  <a href="./process/logout.php" class="btn btn-default btn-flat">Cerrar Session</a>
                </div>
