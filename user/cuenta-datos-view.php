<?php include './lib/config2.php';if( $_SESSION['email']!="" && $_SESSION['clave']!="" && $_SESSION['rol']=="1"){ ?>
...
<?php 
    ...
    /* Actualizar cuenta admin */
        ...
        if(isset($_POST['nombre']) && isset($_POST['apellidos'])&& isset($_POST['password'])){
            $nombre_usuario=MysqlQuery::RequestPost('nombre');
		  ...
		  $mensaje_mail="Hola ".$nombre_usuario." ".$apellidos_admin.",su Contraseña ha cambiado:
		  \n contrase: ".$pass_admin.",
                    ...
                    <!-- Profile Image -->
                        <div class="box box-success">
                            ...
                            <div id="load_img">
                                ...
                                <h3 class="profile-username text-center"><?php echo $grado;?> <?php echo utf8_encode($nombre);?> <?php echo utf8_encode($apellidos);?></h3>
