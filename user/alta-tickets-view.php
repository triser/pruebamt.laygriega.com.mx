...
<?php if($_SESSION['email']!="" && $_SESSION['rol']=="1"){ ?> 


<?php if(isset($_POST['fecha_ticket']) && isset($_POST['descripcion_ticket']) && isset($_POST['puesto_ticket'])){
...
imagejpeg($lienzo, $destino1, 80);
         ...
         $asignado_ticket=  MysqlQuery::RequestPost('asignado_ticket');
         ...
         /* $puesto_ticket= MysqlQuery::RequestPost('puesto_ticket');*/
          ...
          $descripcion_ticket=  MysqlQuery::RequestPost('descripcion_ticket');
			...
			if(MysqlQuery::Guardar("tickets", "fecha_alta, hra_creacion,asignado,id_asunto, mensaje, imagen_tk, id_prioridad_tk, usuario_tk, serie","'$fecha_ticket', '$hra_ticket', '$asignado_ticket', '$email_asignado', '$asunto_ticket', '$descripcion_ticket', '$destino1', '$prioridad_ticket','$iduser', '$id_ticket'")){
...
<div class="wrapper">
  ...
  <div class="box box-info">
      ...
      <div class="box box-default">
        ...
        <select id="usuario" class="form-control" name="asignado_ticket" readonly></select>
        ...
        <select id="usuario" class="form-control" name="email_asignado" readonly></select>
...
window.setTimeout(function() {
    $(".alert").fadeTo(400, 0).slideUp(400, function(){{window.top.location="./index.php?view=tickets"}
        $(this).remove(); 
    });
}, 1000);
