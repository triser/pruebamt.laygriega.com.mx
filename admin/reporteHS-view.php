<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){ ?>
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador ING. JOSE DE JESUS VILLATORO, aqui se muestran todas los Ticket del departamento del Hardware y Software los cuales podra, modificar, Cancela, imprimir y Consultar</p>
            </div>
          </div>
        </div>
            <?php
                ...
                /* Tickets pendientes*/
                $num_ticket_pend=Mysql::consulta(" SELECT * FROM ticket WHERE area_solicitada='Hardware Y Software' AND estado_ticket = 'Pendiente'" );
                $num_total_pend=mysqli_num_rows($num_ticket_pend);

                /* Tickets en proceso*/
                $num_ticket_proceso=Mysql::consulta("SELECT * FROM ticket WHERE area_solicitada='Hardware Y Software' AND estado_ticket = 'En Proceso'");
                $num_total_proceso=mysqli_num_rows($num_ticket_proceso);

                /* Tickets resueltos*/
                $num_ticket_res=Mysql::consulta("SELECT * FROM ticket WHERE area_solicitada='Hardware Y Software' AND estado_ticket = 'Resuelto'");
                $num_total_res=mysqli_num_rows($num_ticket_res);
                
                 /* Tickets Cancelado*/
                $num_ticket_can=Mysql::consulta("SELECT * FROM ticket WHERE area_solicitada='Hardware Y Software' AND estado_ticket = 'Cancelado'");
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-pills nav-justified">
                            <li><a href="./admin.php?view=reporteHS&ticket=all"><i class="fa fa-list"></i>&nbsp;&nbsp;Todos los Ticket&nbsp;&nbsp;<span class="label label-primary"><?php echo $num_total_all; ?></span></a></li>
                            <li><a href="./admin.php?view=reporteHS&ticket=pending"><i class="fa fa-exclamation-triangle"></i>&nbsp;&nbsp;Ticket Pendientes&nbsp;&nbsp;<span class="label label-danger"><?php echo $num_total_pend; ?></span></a></li>
                            <li><a href="./admin.php?view=reporteHS&ticket=process"><i class="fa fa-folder-open"></i>&nbsp;&nbsp;Ticket en Proceso&nbsp;&nbsp;<span class="label label-warning"><?php echo $num_total_proceso; ?></span></a></li>
                            <li><a href="./admin.php?view=reporteHS&ticket=resolved"><i class="fa fa-check-square-o"></i>&nbsp;&nbsp;Ticket Resueltos&nbsp;&nbsp;<span class="label label-success"><?php echo $num_total_res; ?></span></a></li>
                            <li><a href="./admin.php?view=reporteHS&ticket=cancelled"><i class="fa fa-minus-square"></i>&nbsp;&nbsp;Ticket Cancelados&nbsp;&nbsp;<span class="label label-danger"><?php echo $num_total_can; ?></span></a></li>
                        </ul>
                    </div>
                </div>
                <br>
                        ...
                        <div class="table-responsive">
                            <?php
                                ...
                                if(isset($_GET['ticket'])){
                                    if($_GET['ticket']=="all"){
                                        $consulta="SELECT SQL_CALC_FOUND_ROWS * FROM ticket WHERE area_solicitada='Hardware Y Software' LIMIT $inicio, $regpagina";
                                    }elseif($_GET['ticket']=="pending"){
                                        $consulta="SELECT SQL_CALC_FOUND_ROWS * FROM ticket WHERE area_solicitada='Hardware Y Software' AND estado_ticket = 'Pendiente' LIMIT $inicio, $regpagina";
                                    }elseif($_GET['ticket']=="process"){
                                        $consulta="SELECT SQL_CALC_FOUND_ROWS * FROM ticket WHERE area_solicitada='Hardware Y Software' AND estado_ticket = 'En Proceso' LIMIT $inicio, $regpagina";
                                    }elseif($_GET['ticket']=="resolved"){
                                        $consulta="SELECT SQL_CALC_FOUND_ROWS * FROM ticket WHERE area_solicitada='Hardware Y Software' AND estado_ticket = 'Resuelto' LIMIT $inicio, $regpagina";
                                    }elseif($_GET['ticket']=="cancelled"){
                                        $consulta="SELECT SQL_CALC_FOUND_ROWS * FROM ticket WHERE area_solicitada='Hardware Y Software' AND estado_ticket = 'Cancelado' LIMIT $inicio, $regpagina";
                                    }else{
                            ...
                            ?>
                            <table class="table table-hover table-striped table-bordered points_table_admin2 " class="table table-hover">
                                <thead>
                                    <tr>
	...
	?>
                                        ...
                                        <td class="text-center" data-label="Opciones:">
                                            ...
                                            <a href="admin.php?view=ticketeditHS&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-eye" aria-hidden="true"></i></a>
                      ...
                      <nav aria-label="Page navigation" class="text-center">
                            <ul class="pagination">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="./admin.php?view=reporteHS&ticket=<?php echo $ticketselected; ?>&pagina=<?php echo $pagina-1; ?>" aria-label="Previous">
                                ...
                                <?php
                                    for($i=1; $i <= $numeropaginas; $i++ ){
                                        if($pagina == $i){
                                            echo '<li class="active"><a href="./admin.php?view=reporteHS&ticket='.$ticketselected.'&pagina='.$i.'">'.$i.'</a></li>';
                                        }else{
                                            echo '<li><a href="./admin.php?view=reporteHS&ticket='.$ticketselected.'&pagina='.$i.'">'.$i.'</a></li>';
                                        }
                                    }
                                ?>
