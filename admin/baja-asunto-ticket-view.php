...
<i aria-hidden="true"></i> Buscar
  ...
  LEFT JOIN usuario AS U  ON   U.idusuario = EL.idusuario
  LEFT JOIN empleado_personal AS EP ON  U.idusuario = EP.idusuario
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado WHERE estatus_a = 0 ORDER BY id_asunto DESC  LIMIT $inicio, $regpagina");
	...
	?></td>
							...
							<a href="#deli<?php echo $asunto['id_asunto']; ?>" data-toggle="modal" class="btn btn-sm btn-primary"><span class=" glyphicon glyphicon-arrow-up " aria-hidden="true" data-toggle="tooltip" data-placement="left" id="tooltipex" title="Dar de Alta Asunto"></span></a>
