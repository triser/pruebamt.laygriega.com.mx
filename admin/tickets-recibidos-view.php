...
LEFT JOIN asunto AS A ON A.idpuesto = PU.id_puesto AND  T.id_asunto = A.id_asunto
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado
    WHERE T.email_asignado='$email' ORDER BY id DESC");
...
LEFT JOIN asunto AS A ON A.idpuesto = PU.id_puesto AND  T.id_asunto = A.id_asunto
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado
  WHERE estatus_tk='Pendiente' and  T.email_asignado='$email'");
...
LEFT JOIN asunto AS A ON A.idpuesto = PU.id_puesto AND  T.id_asunto = A.id_asunto
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado
  WHERE estatus_tk='En proceso' and T.email_asignado='$email'");
...
LEFT JOIN asunto AS A ON A.idpuesto = PU.id_puesto AND  T.id_asunto = A.id_asunto
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado
  WHERE estatus_tk='Resuelto' and T.email_asignado='$email'");
...
LEFT JOIN asunto AS A ON A.idpuesto = PU.id_puesto AND  T.id_asunto = A.id_asunto
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado
  WHERE estatus_tk='Cancelados' and T.email_asignado='$email'");
...
LEFT JOIN puestos AS PU ON  EL.idpuesto = PU.id_puesto
LEFT JOIN asunto AS A ON A.idpuesto = PU.id_puesto AND  T.id_asunto = A.id_asunto
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado WHERE T.email_asignado='$email' ORDER BY id DESC LIMIT $inicio, $regpagina";
...
LEFT JOIN asunto AS A ON A.idpuesto = PU.id_puesto AND  T.id_asunto = A.id_asunto
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado
  WHERE estatus_tk='Resuelto' and  T.email_asignado='$email' LIMIT $inicio, $regpagina";
...
LEFT JOIN asunto AS A ON A.idpuesto = PU.id_puesto AND  T.id_asunto = A.id_asunto
  LEFT JOIN grado_estudio AS G ON  EL.idgrado = G.id_grado
  WHERE estatus_tk='Cancelados' and  T.email_asignado='$email'  LIMIT $inicio, $regpagina";
                                    }else{
                                        $consulta="SELECT SQL_CALC_FOUND_ROWS * FROM tickets AS T
  LEFT JOIN usuario AS U ON T.id_usuario_tk = U.idusuario
  LEFT JOIN prioridad_tk AS P ON  T.id_prioridad_tk = P.id_prioridad_tk
