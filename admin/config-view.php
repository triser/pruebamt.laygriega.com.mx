<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ 
    ...
    if(isset($_POST['nom_admin_reg']) && isset($_POST['admin_reg']) && isset($_POST['admin_clave_reg'])){
       ...
       if(MysqlQuery::Guardar("administrador", "nombre_completo, nombre_admin, clave, email_admin", "'$nom_complete_save', '$nom_admin_save', '$pass_save', '$email_save'")){
        ...
        $nom_complete_save = $_POST['nom_admin_reg'];
        $nom_admin_save['admin_reg'];
        ...
        $cabeceras = "From: Cuenta de ADMNISTRADOR"; //La persona que envia el correo
        $asunto = "Cuenta de Registro Administrador"; //El asunto
        $email_to = "$email_save, sistemaom@laygriega.com.mx"; //cambiar por tu email
        $mensaje_mail="Hola Admin ".$nom_complete_save.", los siguientes datos de tu cuenta como ADMINISTRADOR fueron creados y son los siguientes:
        \nNombre Completo: ".$nom_complete_save."
        \nNombre de usuario : ".$nom_admin_save."
        \nNueva Clave: ".$pass_save."
        \nEmail: ".$email_save."
        \nPara poder ACCESAR por favor Visitanos en el siguiente enlace http://www.sistemaom.laygriega.com.mx";
       ...
       /* Actualizar cuenta admin */
        ...
        $nombre_complete_update = $_POST['nom_admin_up'];
        $nom_admin_update['admin_up'];
        $pass_admin_update = $_POST['admin_clave_up'];
        $message = $_POST['message'];
        $email_admin_update = $_POST['admin_email_up'];


        //Preparamos el mensaje de contacto
        $cabeceras = "From: Administrador: Tu cuenta fue actualizado Exitosamente"; //La persona que envia el correo
        $asunto = "Actualizacion de cuenta Administrador"; //El asunto
        $email_to = "$email_admin_update, sistemaom@laygriega.com.mx"; //cambiar por tu email
        ...
        \nNombre de usuario : ".$nom_admin_update."
        \nNueva Clave: ".$pass_admin_update."
        \nEmail: ".$email_admin_update."
...
if (@mail($email_to, $asunto ,$mensaje_mail ,$cabeceras )) ;
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-3">
             <center> <img src="./img/config.png" alt="Image" class="img-responsive"></center>
            </div>
            <div class="col-sm-9">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 animated flip">
                <h1 class="text-danger">Lo sentimos esta página es solamente para administradores de Sistema OM La Y Griega</h1>
