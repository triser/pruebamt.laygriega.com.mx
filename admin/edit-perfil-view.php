...
CE.nombre_eme,CE.apellidos_eme,CE.colonia_eme,CE.direccion_eme,CE.telefono_eme,CE.telefono_eme2 FROM  usuario AS U
   ...
   LEFT JOIN contacto_emergencia AS CE ON U.id_emergencia = CE.idemergencia WHERE idusuario ='$id'");
        ...
        <div class="col-md-12">
          <div class="box box-info collapsed-box "> 
            <div class="box-header with-border">
              <h3 class="box-title">Actualizar Datos de Cuenta</h3>
            ...
            <div class="col-md-4">
              <div class="form-group">
                      ...
                      <label class="col-md-2 control-label">Correo</label>
                            <div class='col-sm-8'>
                                <div class="input-group">
                                    <input class="form-control" type="text" readonly value="<?php echo $reg['email_usuario']; ?>" readonly>
                 ...
                 <div class="form-group">
                            ...
                            <div class='col-sm-8'>
                                <div class="input-group">
                                       <input class="form-control" name="clave" type="password" readonly value="">
                                    <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
                                </div>
                            </div>
                   </div>  
                ...
                <div class="col-md-4">
                 <div class="form-group">
                            ...
                            <div class='col-sm-8'>
                                <div class="input-group">
                               <input class="form-control" name="sangre" type="text" readonly value="<?php echo utf8_encode($reg['sangre']); ?>">
                                <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
                            </div> </div>
                   </div>
              </div>
             ...
             <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-12 text-center">
                             <button type="submit" class="btn btn-primary"><i class="fa fa-refresh fa-spin fa-1x fa-fw"></i>&nbsp;Actualizar</button>
                              <a href="./admin.php?view=perfil" class="btn btn-success"><i class="fa fa-reply"></i>&nbsp;&nbsp;Volver</a>
                          </div>
                        </div> </div>
          </form>
              </div><!-- /.box footer -->
...
window.setTimeout(function() {
    $(".alert").fadeTo(400, 0).slideUp(400, function(){{window.top.location="./admin.php?view=perfil"}
        $(this).remove(); 
    });
}, 1000);
