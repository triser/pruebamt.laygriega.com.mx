                ...
                <div class="row">
                    <div class="col-md">
                        <ul class="nav nav-pills nav-justified">
                            <li><a href="./admin.php?view=reporteCS&ticket=all"><i class="fa fa-list"></i>&nbsp;&nbsp;Todos los Ticket&nbsp;&nbsp;<span class="label label-primary"><?php echo $num_total_all; ?></span></a></li>
                            <li><a href="./admin.php?view=reporteCS&ticket=pending"><i class="fa fa-exclamation-triangle"></i>&nbsp;&nbsp;Ticket Pendientes&nbsp;&nbsp;<span class="label label-danger"><?php echo $num_total_pend; ?></span></a></li>
                            <li><a href="./admin.php?view=reporteCS&ticket=process"><i class="fa fa-folder-open"></i>&nbsp;&nbsp;Ticket en proceso&nbsp;&nbsp;<span class="label label-warning"><?php echo $num_total_proceso; ?></span></a></li>
                            <li><a href="./admin.php?view=reporteCS&ticket=resolved"><i class="fa fa-check-square-o"></i>&nbsp;&nbsp;Ticket resueltos&nbsp;&nbsp;<span class="label label-success"><?php echo $num_total_res; ?></span></a></li>
                            <li><a href="./admin.php?view=reporteCS&ticket=cancelled"><i class="fa fa-minus-square"></i>&nbsp;&nbsp;Ticket Cancelados&nbsp;&nbsp;<span class="label label-danger"><?php echo $num_total_can; ?></span></a></li>
                        </ul>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md">
                        <div class="table-responsive">
                            ...
                            ?>
                            <table class="table table-hover table-striped table-bordered points_table_admin3 " class="table table-hover">
                                <thead>
                                    <tr>
	...
	?>
                      ...
                      <nav aria-label="Page navigation" class="text-center">
                            <ul class="pagination">
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="./admin.php?view=reporteCS&ticket=<?php echo $ticketselected; ?>&pagina=<?php echo $pagina-1; ?>" aria-label="Previous">
                                ...
                                <?php
                                    for($i=1; $i <= $numeropaginas; $i++ ){
                                        if($pagina == $i){
                                            echo '<li class="active"><a href="./admin.php?view=reporteCS&ticket='.$ticketselected.'&pagina='.$i.'">'.$i.'</a></li>';
                                        }else{
                                            echo '<li><a href="./admin.php?view=reporteCS&ticket='.$ticketselected.'&pagina='.$i.'">'.$i.'</a></li>';
                                        }
                                    }
                                ?>
