<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, en esta página se muestran todos los usuarios y administradores registrados en el Sistema OM LA Y GRIEGA, usted podra eliminarlos si lo desea.</p>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            ?>
                            <table class="table table-hover table-striped table-bordered table_admin">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $row['fecha_modificacion']; ?></td>
                            ...
                            <?php else: ?>
                                <h2 class="text-center">No hay administradores registrados en el Sistema OM LA Y GRIEGA</h2>
                            <?php endif; ?>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 animated flip">
                    <h1 class="text-danger">Lo sentimos esta página es solamente para administradores del Sistema de Ordenes de Mejora (OM) LA Y GRIEGA</h1>
